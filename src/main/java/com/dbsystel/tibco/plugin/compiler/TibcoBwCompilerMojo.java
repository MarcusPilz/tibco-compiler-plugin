package com.dbsystel.tibco.plugin.compiler;
...
import com.dbsystel.tibco.plugin.cli.DesignerCommandException;
import com.dbsystel.tibco.plugin.cli.ValidateProjectCommand;
 ...
 * @goal compile
 */
public class TibcoBwCompilerMojo extends AbstractMojo {
	/**
	 * The maven project
	 * 
